...
class ElementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create element" do
    assert_difference('Element.count') do
      post elements_url, params: { element: { content: @element.content, element_type: @element.element_type, position: @element.position, post_id: @element.post_id, text: @element.text } }
    end
  ...
  test "should update element" do
    patch element_url(@element), params: { element: { content: @element.content, element_type: @element.element_type, position: @element.position, post_id: @element.post_id, text: @element.text } }
